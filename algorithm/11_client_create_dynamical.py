...
#由寄件客户创建express，sender，receiver数据库的新快递单
...
try:
    ...
    get_sender_name = "select name from home.client where find_in_set(%s, telephone) > 0 and find_in_set(%s, code)> 0"
    ...
    try:
        if n1 != 0:
            ...
            n2 = ""
            a2 = ""
#打开指定箱子 model Turn_New_Mainwindow
            id = ""#放入物品，返回坐标
